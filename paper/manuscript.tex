...
\textbf{Results:} The agent achieved 100\% pass rates in single-run evaluation. However, repeated runs revealed that one of six tasks---a distributed lock bug fix---succeeded in only 3 of 5 attempts (VI = 2.56), despite every implementation being semantically correct. Failures arose from interface incompatibility and temporal instability.
