...
We designed a benchmark suite of 18 core software development tasks (Table~I) comprising 162 test assertions, organized along two dimensions. The benchmark was further extended to 50 tasks totaling 414 assertions, with the full task set described in the supplementary materials., forming our primary evaluation benchmark, which received full repeated-measures evaluation.: task type and difficulty level. The four task types represent core software engineering activities:
