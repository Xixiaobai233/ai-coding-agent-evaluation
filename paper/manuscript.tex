...
\begin{enumerate}
 ...
 \item A comprehensive empirical evaluation of Claude Code with deepseek-v4-flash, achieving 100\% task pass rate and 100\% test assertion pass rate across 414 tests in four programming languages in single-run evaluation, complemented by a variability analysis across 30 repeated runs.
