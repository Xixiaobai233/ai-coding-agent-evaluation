...
\begin{enumerate}
 ...
 \item A three-layer analysis framework (semantic correctness, interface compatibility, temporal stability) for understanding AI code reliability beyond single-run pass/fail, with a case study demonstrating all three layers.
 \item A variance index for quantifying run-to-run reliability, supported by empirical data from 30 repeated runs.
\end{enumerate}
