...
\begin{enumerate}
 ...
 \item A comprehensive empirical evaluation of Claude Code with deepseek-v4-flash, achieving 100\% task pass rate and 100\% test assertion pass rate across 450+ tests in four programming languages in single-run evaluation, complemented by a variability analysis across 30 repeated runs.
...
We designed a benchmark suite of 50 software development tasks organized along two dimensions: task type and difficulty level. The four task types represent core software engineering activities:
...
Within our small-scale benchmark, the Claude Code framework achieved a 100\% task pass rate, successfully completing all 50 tasks across the four categories and three difficulty levels. A total of 450+ individual test assertions were executed, all of which passed (100\%). Table~\ref{tab:overall_results} summarizes the aggregate results.
